const tone: Record<string, string> = {
  ...
  suspended: "border-red-400/40 bg-red-400/10 text-red-200",
  ...
  stable: "border-emerald-400/40 bg-emerald-400/10 text-emerald-200",
  attention: "border-amber-400/50 bg-amber-400/10 text-amber-200",
  critical: "border-red-400/40 bg-red-400/10 text-red-200",
  configured: "border-emerald-400/40 bg-emerald-400/10 text-emerald-200",
  not_configured: "border-slate-400/30 bg-slate-400/10 text-slate-200",
