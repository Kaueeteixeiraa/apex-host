...
mkdir -p "$APP_DIR" "$APP_DIR/deployments" "$APP_DIR/backups" "$APP_DIR/data/repos" "$APP_DIR/data/backups" "$APP_DIR/data/certbot/www" "$APP_DIR/data/letsencrypt" "$APP_DIR/data/nginx-fallback"
