...
class User(Base):
    ...
    access_profile: Mapped[str] = mapped_column("plan", String(50), default="viewer", nullable=False)
...
class Project(Base):
    ...
    output_directory: Mapped[str | None] = mapped_column(String(255))
...
class PlatformSetting(Base):
    ...
    primary_domain: Mapped[str | None] = mapped_column(String(255))
    public_app_url: Mapped[str | None] = mapped_column(String(500))
    contact_email: Mapped[str | None] = mapped_column(String(255))
    installation_completed: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    installation_completed_at: Mapped[datetime | None] = mapped_column(DateTime)
    ...
    default_user_profile: Mapped[str] = mapped_column("default_user_plan", String(80), default="viewer", nullable=False)
